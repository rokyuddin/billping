      ...
      <div className="w-full max-w-md">
        ...
        <div className="brutal-card p-8 bg-card">
          <div className="text-center mb-8">
            <h1 className="font-heading text-3xl font-bold mb-2">JOIN THE RESISTANCE.</h1>
            <p className="text-muted-foreground">Start saving money today.</p>
          </div>

          <form action={signUp} className="space-y-4">
            <div>
              <label className="block font-bold mb-1 text-sm uppercase" htmlFor="name">Full Name</label>
              <input 
                type="text" 
                id="name"
                name="name"
